...
function SwipeBackWrapper({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `app-viewport fixed inset-0 w-full h-full overflow-hidden bg-slate-50 dark:bg-slate-950 z-30 ${className}`
  }, /*#__PURE__*/React.createElement("div", {
    ref: page1Ref,
    ...
    onRefresh: onRefresh,
    className: "w-full h-full px-4 pt-4 pb-24"
...
function FullJalaliDatePicker({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "relative w-full h-[210px] bg-slate-50/70 dark:bg-slate-950/40 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800/50 flex shadow-inner"
  }, /*#__PURE__*/React.createElement("div", {
...
function IOSWheelPicker({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "relative w-full h-[180px] bg-slate-50/70 dark:bg-slate-950/40 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800/50 flex"
  }, /*#__PURE__*/React.createElement("div", {
...
function GlobalConfirmDialog({
  ...
  return /*#__PURE__*/React.createElement(AnimatePresence, null, isOpen && /*#__PURE__*/React.createElement(motion.div, {
    ...
    className: "mt-3 p-3 bg-slate-50 dark:bg-slate-900/80 rounded-2xl border border-slate-100 dark:border-slate-700/60 text-right space-y-1.5 text-xs"
  }, /*#__PURE__*/React.createElement("span", {
...
function SwipeableTxCard({
  ...
  return /*#__PURE__*/React.createElement(SwipeToDeleteItem, {
    ...
    className: `w-12 h-12 rounded-2xl ${tx.type === 'debt' || tx.type === 'demand_repayment' ? 'bg-rose-50 dark:bg-rose-950/50 text-rose-500 dark:text-rose-400' : isRepay ? 'bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400' : colorType === 'rose' ? 'bg-rose-50 dark:bg-rose-950/50 text-rose-500 dark:text-rose-400' : colorType === 'emerald' ? 'bg-emerald-50 dark:bg-emerald-950/50 text-emerald-500 dark:text-emerald-400' : 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400'} flex items-center justify-center shrink-0`
  }, totalCount ? totalCount - index : /*#__PURE__*/React.createElement(Icon, {
    name: tx.type === 'demand_repayment' ? "arrow-down-left" : isRepay ? "check-circle-2" : tx.type === 'debt' ? "arrow-down-left" : "arrow-up-right",
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("div", {
...
function ContactSelectorCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `w-full bg-slate-50 dark:bg-slate-900 border rounded-xl py-2.5 pr-9 pl-3 text-xs focus:outline-none focus:ring-2 ${error ? 'border-rose-500 ring-2 ring-rose-500/20' : 'border-slate-200 dark:border-slate-700 focus:ring-indigo-500'}`
  })), /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: `p-2.5 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${isSelected ? 'bg-indigo-50 dark:bg-indigo-950/60 border-indigo-500 dark:border-indigo-600 font-bold text-indigo-700 dark:text-indigo-300' : 'bg-slate-50 dark:bg-slate-900/60 border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:border-slate-300'}`
    }, /*#__PURE__*/React.createElement("div", {
...
function LoanSelectorCard({
  ...
  if (selectedLoanObj) {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "\u067E\u0631\u0648\u0646\u062F\u0647 \u0648\u0627\u0645 \u0627\u0646\u062A\u062E\u0627\u0628\u200C\u0634\u062F\u0647:")), /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u0642\u0633\u0637 \u0634\u0645\u0627\u0631\u0647"), /*#__PURE__*/React.createElement("span", {
      className: "text-3xl font-black tracking-tight leading-none my-1 text-white"
    }, nextInstNum), /*#__PURE__*/React.createElement("span", {
    ...
    }, "\u062A\u0627\u0631\u06CC\u062E \u067E\u0631\u062F\u0627\u062E\u062A \u0627\u06CC\u0646 \u0642\u0633\u0637:"), /*#__PURE__*/React.createElement("span", {
      ...
      dir: "ltr"
    }, nextDueDateFormatted)), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center justify-between"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-xs text-indigo-200 font-medium"
    }, "\u0645\u0628\u0644\u063A \u0642\u0633\u0637:"), /*#__PURE__*/React.createElement("span", {
      className: "text-base font-black text-amber-300"
    }, instAmountFormatted, " \u062A\u0648\u0645\u0627\u0646")))), isExpanded ? /*#__PURE__*/React.createElement("div", {
...
function App() {
  ...
  const performDeleteTx = (txToDelete, txType) => {
    ...
    if (txType === 'loan_installment') {
      ...
      if (periodId) {
        ...
        updatedTxs = updatedTxs.map(t => t.periodId === periodId ? {
          ...t,
          periodId: undefined
        } : t);
  ...
  const loanWizardCards = [{
    ...
    render: () => /*#__PURE__*/React.createElement("div", {
      ...
      className: `w-full bg-slate-50 dark:bg-slate-900 border rounded-xl p-3 text-xs focus:outline-none transition-all ${validationErrors.loan_title ? 'border-rose-500 ring-2 ring-rose-500/20 bg-rose-50/20 dark:bg-rose-950/20' : 'border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-indigo-500'}`
    ...
    render: () => {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "bg-slate-50 dark:bg-slate-900 rounded-2xl p-3 border border-slate-200 dark:border-slate-800 space-y-3"
      }, /*#__PURE__*/React.createElement("div", {
        ...
        className: "text-[10px] text-indigo-700/80 dark:text-indigo-300/80 font-bold"
      }, "\u0645\u0627\u0647 \u0627\u0648\u0644\u06CC\u0646 \u0642\u0633\u0637"), /*#__PURE__*/React.createElement("div", {
        className: "text-xs sm:text-sm font-extrabold text-indigo-900 dark:text-indigo-100 mt-0.5"
      }, curMonthName, " ", curYear)), /*#__PURE__*/React.createElement("button", {
        type: "button",
    ...
    switch (tabName) {
      case 'dashboard':
        return /*#__PURE__*/React.createElement("div", {
          ...
          return /*#__PURE__*/React.createElement("div", {
            className: "bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-700/60 transition-all"
          }, /*#__PURE__*/React.createElement("div", {
            ...
            className: "w-8 h-8 rounded-xl bg-red-50 dark:bg-red-950/50 flex items-center justify-center text-red-500 group-hover:scale-105 transition-transform"
          }, /*#__PURE__*/React.createElement(Icon, {
            name: "calendar-clock",
            className: "w-4 h-4"
            ...
            className: "text-[10px] text-slate-400"
          }, "\u0646\u0632\u062F\u06CC\u06A9\u200C\u062A\u0631\u06CC\u0646 \u0633\u0631\u0631\u0633\u06CC\u062F\u0647\u0627 (", sortedList.length, " \u0645\u0648\u0631\u062F)"))), /*#__PURE__*/React.createElement("button", {
            type: "button",
            onClick: e => {
              e.stopPropagation();
            ...
            name: "chevron-down",
            className: `w-4 h-4 transition-transform duration-300 ${expandedReminders ? 'rotate-180' : 'rotate-0'}`
          }))), /*#__PURE__*/React.createElement("div", {
            className: "space-y-2.5 mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-700/60"
          }, firstTwo.map(item => /*#__PURE__*/React.createElement("div", {
            key: item.id,
            ...
            className: `w-7 h-7 rounded-full flex items-center justify-center ${item.color}`
          }, /*#__PURE__*/React.createElement(Icon, {
            name: item.icon || "landmark",
            className: "w-3.5 h-3.5"
          })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
            className: "text-xs font-bold text-slate-800 dark:text-slate-200"
          }, item.title), /*#__PURE__*/React.createElement("div", {
            className: "text-[10px] text-slate-400"
          }, item.dateStr))), /*#__PURE__*/React.createElement("span", {
            className: `text-[11px] font-bold px-2 py-0.5 rounded-full ${item.daysLeft <= 0 ? 'text-red-600 bg-red-100 dark:bg-red-950/80' : 'text-indigo-600 bg-indigo-50 dark:bg-indigo-950/40'}`
          }, item.daysLeft < 0 ? `${Math.abs(item.daysLeft)} روز تأخیر` : item.daysLeft === 0 ? 'امروز' : `${item.daysLeft} روز مانده`))), /*#__PURE__*/React.createElement(AnimatePresence, {
            initial: false
          }, expandedReminders && extraList.length > 0 && /*#__PURE__*/React.createElement(motion.div, {
          ...
          }, extraList.map(item => /*#__PURE__*/React.createElement("div", {
            key: item.id,
            onClick: () => item.loanObj && openLoanDetail(item.loanObj),
            className: `flex items-center justify-between py-1.5 border-b border-slate-50 dark:border-slate-700/40 last:border-0 ${item.loanObj ? 'cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/30 px-1 rounded-lg transition-colors' : ''}`
          }, /*#__PURE__*/React.createElement("div", {
          ...
          className: "bg-white dark:bg-slate-800 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-700/60 space-y-3"
        }, /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between items-center border-b border-slate-100 dark:border-slate-700 pb-2"
        }, /*#__PURE__*/React.createElement("h3", {
          className: "text-xs font-bold text-slate-900 dark:text-white flex items-center space-x-1.5 space-x-reverse"
        }, /*#__PURE__*/React.createElement(Icon, {
          name: "history",
          ...
          className: `w-8 h-8 rounded-full flex items-center justify-center ${tx.isPositive ? 'bg-emerald-50 text-emerald-600' : 'bg-red-50 text-red-500'}`
        }, /*#__PURE__*/React.createElement(Icon, {
          name: tx.isPositive ? 'arrow-down-left' : 'arrow-up-right',
          className: "w-4 h-4"
        })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
          className: "text-xs font-bold text-slate-800 dark:text-slate-200"
        }, tx.title), /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-slate-400"
        }, tx.dateStr))), /*#__PURE__*/React.createElement("div", {
          className: "flex flex-col items-start text-left shrink-0 max-w-[130px] sm:max-w-none"
        }, /*#__PURE__*/React.createElement("span", {
          className: `text-xs font-bold text-left block w-full leading-tight whitespace-normal break-words ${tx.isPositive ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500 dark:text-red-400'}`
      ...
      case 'contacts':
        return /*#__PURE__*/React.createElement("div", {
          ...
          return /*#__PURE__*/React.createElement(SwipeToDeleteItem, {
            ...
            className: "bg-white dark:bg-slate-800 rounded-2xl sm:rounded-[24px] border border-slate-100 dark:border-slate-700/60 p-4 shadow-sm hover:border-indigo-300 transition-all cursor-pointer"
          }, /*#__PURE__*/React.createElement("div", {
            ...
            className: `flex-1 rounded-2xl h-8 text-xs font-medium transition-all flex items-center justify-center gap-1 ${hasActiveLoan ? 'bg-blue-600 text-white shadow-sm active:scale-95' : 'bg-slate-100 dark:bg-slate-700/50 text-slate-400 dark:text-slate-500 cursor-default'}`
          }, hasSettledLoan && /*#__PURE__*/React.createElement(Icon, {
            name: "check",
            className: "w-4 h-4 shrink-0"
            ...
            className: `flex-1 rounded-2xl h-8 text-xs font-medium transition-all flex items-center justify-center gap-1 ${hasActiveDemand ? 'bg-emerald-600 text-white shadow-sm active:scale-95' : 'bg-slate-100 dark:bg-slate-700/50 text-slate-400 dark:text-slate-500 cursor-default'}`
          }, hasSettledDemand && /*#__PURE__*/React.createElement(Icon, {
            name: "check",
            className: "w-4 h-4 shrink-0"
            ...
            className: `flex-1 rounded-2xl h-8 text-xs font-medium transition-all flex items-center justify-center gap-1 ${hasActiveDebt ? 'bg-rose-600 text-white shadow-sm active:scale-95' : 'bg-slate-100 dark:bg-slate-700/50 text-slate-400 dark:text-slate-500 cursor-default'}`
          }, hasSettledDebt && /*#__PURE__*/React.createElement(Icon, {
            name: "check",
            className: "w-4 h-4 shrink-0"
      ...
      case 'loan-detail':
        ...
        return /*#__PURE__*/React.createElement("div", {
        ...
        }, isClosed ? 'پرونده تسویه‌شده' : 'پرونده فعال'))))), /*#__PURE__*/React.createElement("div", {
          ...
          className: "bg-slate-50/70 dark:bg-slate-900/50 border border-slate-200/80 dark:border-slate-700/70 rounded-2xl p-2.5 sm:p-3 flex items-center gap-2.5"
        }, /*#__PURE__*/React.createElement("div", {
      ...
      case 'archived-period-detail':
        ...
        React.createElement("svg", {
          ...
          className: "bg-white dark:bg-slate-800 p-6 rounded-3xl text-center text-xs text-slate-400 border border-slate-100 dark:border-slate-700/60 card-shadow"
        }, "\u0647\u0646\u0648\u0632 \u062A\u0631\u0627\u06A9\u0646\u0634\u06CC \u0628\u0631\u0627\u06CC \u0627\u06CC\u0646 \u062F\u0648\u0631\u0647 \u062B\u0628\u062A \u0646\u0634\u062F\u0647 \u0627\u0633\u062A") : /*#__PURE__*/React.createElement("div", {
          className: "space-y-3"
      ...
      case 'all-transactions':
        return /*#__PURE__*/React.createElement("div", {
        ...
        }, "\u0647\u0645\u0647 \u062A\u0631\u0627\u06A9\u0646\u0634\u200C\u0647\u0627"), /*#__PURE__*/React.createElement("p", {
          className: "text-[10px] text-slate-400"
        }, "\u0644\u06CC\u0633\u062A \u06A9\u0627\u0645\u0644 \u062A\u0631\u0627\u06A9\u0646\u0634\u200C\u0647\u0627\u06CC \u062B\u0628\u062A \u0634\u062F\u0647")), /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] font-bold text-indigo-600 bg-indigo-50 dark:bg-indigo-950/60 px-2.5 py-1 rounded-full border border-indigo-200 dark:border-indigo-800/60"
        }, transactions.length, " \u0645\u0648\u0631\u062F")), /*#__PURE__*/React.createElement("div", {
          className: "bg-white dark:bg-slate-800 rounded-3xl p-4 shadow-sm border border-slate-100 dark:border-slate-700/60 space-y-3"
        }, /*#__PURE__*/React.createElement("div", {
          className: "space-y-2.5"
          ...
          className: `w-9 h-9 rounded-full flex items-center justify-center ${tx.isPositive ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-950/60' : 'bg-red-50 text-red-500 dark:bg-red-950/60'}`
        }, /*#__PURE__*/React.createElement(Icon, {
          name: tx.isPositive ? 'arrow-down-left' : 'arrow-up-right',
        ...
        }, formatDateToNumericJalali(tx.dateStr)))), /*#__PURE__*/React.createElement("div", {
          className: "flex flex-col items-start text-left shrink-0 max-w-[130px] sm:max-w-none"
        }, /*#__PURE__*/React.createElement("span", {
          className: `text-xs font-black text-left block w-full leading-tight whitespace-normal break-words ${tx.isPositive ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500 dark:text-red-400'}`
        }, tx.isPositive ? `+${Math.abs(tx.amount).toLocaleString()}` : `${Math.abs(tx.amount).toLocaleString()}`, " \u062A\u0648\u0645\u0627\u0646")))), transactions.length === 0 && /*#__PURE__*/React.createElement("div", {
          ...
          return /*#__PURE__*/React.createElement("div", {
            className: "pt-3 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between text-xs font-bold"
          }, /*#__PURE__*/React.createElement("button", {
            disabled: allTxsPage <= 1,
            onClick: () => setAllTxsPage(p => Math.max(1, p - 1)),
            className: `px-3 py-1.5 rounded-xl border flex items-center space-x-1 space-x-reverse transition-all ${allTxsPage <= 1 ? 'opacity-40 cursor-not-allowed bg-slate-100 dark:bg-slate-800 text-slate-400 border-transparent' : 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800 hover:bg-indigo-100'}`
          }, /*#__PURE__*/React.createElement(Icon, {
            name: "chevron-right",
            className: "w-4 h-4"
          }), /*#__PURE__*/React.createElement("span", null, "\u0635\u0641\u062D\u0647 \u0642\u0628\u0644")), /*#__PURE__*/React.createElement("span", {
            className: "text-slate-600 dark:text-slate-300 font-extrabold px-2 py-1 rounded-lg bg-slate-100 dark:bg-slate-700/60"
          }, "\u0635\u0641\u062D\u0647 ", allTxsPage, " \u0627\u0632 ", totalPages), /*#__PURE__*/React.createElement("button", {
            disabled: allTxsPage >= totalPages,
            onClick: () => setAllTxsPage(p => Math.min(totalPages, p + 1)),
            className: `px-3 py-1.5 rounded-xl border flex items-center space-x-1 space-x-reverse transition-all ${allTxsPage >= totalPages ? 'opacity-40 cursor-not-allowed bg-slate-100 dark:bg-slate-800 text-slate-400 border-transparent' : 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800 hover:bg-indigo-100'}`
      ...
      case 'settings':
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "bg-slate-50 dark:bg-slate-900/60 rounded-2xl p-3 border border-slate-100 dark:border-slate-800"
        }, /*#__PURE__*/React.createElement("div", {
          ...
          className: `w-8 h-8 rounded-xl flex items-center justify-center shrink-0 ${versionData.isUpdateAvailable ? 'bg-amber-100 text-amber-600 dark:bg-amber-950 dark:text-amber-400' : 'bg-emerald-100 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400'}`
        }, /*#__PURE__*/React.createElement(Icon, {
          name: versionData.isUpdateAvailable ? 'arrow-up-circle' : 'check-circle-2',
          className: "w-4 h-4"
        })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
          className: "text-xs font-bold text-slate-800 dark:text-slate-200"
        }, versionData.isUpdateAvailable ? `نسخه جدیدتر ${versionData.latestVersion} موجود است` : 'برنامه شما کاملاً بروز است'), /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-slate-400 mt-0.5"
        }, versionData.isUpdateAvailable ? 'امکانات و بهبودهای جدید آماده دریافت است.' : 'شما از آخرین نسخه پایدار Amir Finance استفاده می‌کنید.')))), /*#__PURE__*/React.createElement("div", {
          className: "flex items-center space-x-2 space-x-reverse pt-1"
        }, /*#__PURE__*/React.createElement("button", {
          ...
          name: isCheckingUpdate ? 'refresh-cw' : 'rotate-cw',
          className: `w-3.5 h-3.5 ${isCheckingUpdate ? 'animate-spin' : ''}`
        }), /*#__PURE__*/React.createElement("span", null, isCheckingUpdate ? 'در حال بررسی...' : 'بررسی بروزرسانی')), versionData.isUpdateAvailable && /*#__PURE__*/React.createElement("button", {
          ...
          name: "download",
          className: "w-3.5 h-3.5"
        }), /*#__PURE__*/React.createElement("span", null, "\u0628\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC")))), versionData.history && versionData.history.length > 0 && (() => {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            className: "text-xs font-bold text-slate-800 dark:text-slate-200"
          }, "\u062A\u0627\u0631\u06CC\u062E\u0686\u0647 \u062A\u063A\u06CC\u06CC\u0631\u0627\u062A \u0646\u0633\u062E\u0647 (Changelog)"), /*#__PURE__*/React.createElement("span", {
            className: "text-[10px] text-slate-400 font-mono"
          }, historyList.length, " \u0627\u0646\u062A\u0634\u0627\u0631")), /*#__PURE__*/React.createElement("div", {
            className: "space-y-2"
            ...
            return /*#__PURE__*/React.createElement("div", {
              ...
              className: "flex items-center space-x-2.5 space-x-reverse min-w-0"
            }, /*#__PURE__*/React.createElement("div", {
              className: `w-2 h-2 rounded-full shrink-0 ${isCurrent ? 'bg-emerald-500 shadow-xs' : 'bg-slate-300 dark:bg-slate-600'}`
            }), /*#__PURE__*/React.createElement("div", {
              className: "min-w-0"
            }, /*#__PURE__*/React.createElement("div", {
              className: "flex items-center space-x-2 space-x-reverse flex-wrap gap-1"
            }, /*#__PURE__*/React.createElement("span", {
              className: "text-xs font-bold text-slate-800 dark:text-slate-100 font-mono"
            }, "\u0646\u0633\u062E\u0647 ", ver.version), /*#__PURE__*/React.createElement("span", {
              className: "text-[9px] font-mono text-slate-400"
            }, "(\u0628\u06CC\u0644\u062F ", ver.buildNumber, ")"), isCurrent && /*#__PURE__*/React.createElement("span", {
              className: "text-[9px] bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400 font-bold px-1.5 py-0.2 rounded-full"
            }, "\u0646\u0635\u0628\u200C\u0634\u062F\u0647")), /*#__PURE__*/React.createElement("div", {
              className: "text-[10px] text-slate-400 mt-0.5"
            }, "\u062A\u0627\u0631\u06CC\u062E \u0627\u0646\u062A\u0634\u0627\u0631: ", ver.releaseDate))), /*#__PURE__*/React.createElement(Icon, {
              name: "chevron-down",
              className: `w-4 h-4 text-slate-400 shrink-0 transition-transform duration-300 ease-in-out ${isExpanded ? 'rotate-180' : ''}`
            })), /*#__PURE__*/React.createElement("div", {
              ...
              className: "px-3.5 pb-3 pt-1 border-t border-slate-200/50 dark:border-slate-800/80 text-xs text-slate-600 dark:text-slate-300 space-y-1.5"
            }, ver.commitMessage && /*#__PURE__*/React.createElement("div", {
              className: "text-[10px] font-mono text-slate-400 bg-slate-100 dark:bg-slate-800/80 p-1.5 rounded-lg border border-slate-200/40 dark:border-slate-700/40 dir-ltr text-left overflow-x-auto truncate"
            }, "git: ", ver.commitMessage), /*#__PURE__*/React.createElement("div", {
          ...
          }), hasMoreVersions && /*#__PURE__*/React.createElement("button", {
            type: "button",
            onClick: e => {
              e.stopPropagation();
          ...
          }, /*#__PURE__*/React.createElement("span", null, showAllVersions ? 'بستن نسخه‌های قدیمی‌تر' : `نمایش نسخه‌های قدیمی‌تر (${historyList.length - 5} نسخه دیگر)`), /*#__PURE__*/React.createElement(Icon, {
            name: "chevron-down",
            className: `w-4 h-4 transition-transform duration-300 ${showAllVersions ? 'rotate-180' : ''}`
          }))));
        })()))), /*#__PURE__*/React.createElement("div", {
          ...
          className: "flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-100 dark:border-slate-700"
        }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
          className: "text-xs font-bold text-slate-800 dark:text-slate-200"
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `w-full h-full flex flex-col justify-between ${isDark ? 'dark bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'}`
    ...
    className: "absolute bottom-0 left-0 right-0 h-16 bg-white dark:bg-slate-900 border-t border-slate-200/80 dark:border-slate-800 flex items-center justify-around px-2 z-40"
    ...
    if (periods.length === 0) {
      return /*#__PURE__*/React.createElement("div", {
        className: "bg-slate-50 dark:bg-slate-800/60 p-6 rounded-2xl text-center text-xs text-slate-400"
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      key: period.id,
      className: "bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-700/80 space-y-2"
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex justify-between items-center"
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-xs font-bold text-slate-900 dark:text-white"
    ...
    className: "mt-2 p-2.5 bg-slate-50 dark:bg-slate-900 rounded-xl text-[11px] font-bold text-slate-700 dark:text-slate-300"
    ...
    className: "flex-1 bg-slate-100 dark:bg-slate-700 py-2 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300"
  }, "\u0627\u0646\u0635\u0631\u0627\u0641"))))), /*#__PURE__*/React.createElement(GlobalConfirmDialog, _extends({

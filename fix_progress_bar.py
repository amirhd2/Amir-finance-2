...
old_progress = '''                                                                                    <div className="w-full flex flex-col gap-1 px-1">
...
new_progress = '''                                                                                    <div className="w-full flex flex-col gap-1.5 px-1 mt-1">
                                                                                        <div className="flex justify-between items-center text-[10px] font-bold">
                                                                                            <span className="text-emerald-600 dark:text-emerald-400">{nextDueInfo.paidInst} پرداخت شده</span>
...
app = app.replace(old_progress, new_progress)
